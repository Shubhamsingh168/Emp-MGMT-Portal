        ...
        <>
            <div className='flex-shrink-0 h-full p-5 w-[300px] bg-yellow-500 rounded-xl'>
                ...
                <div className='flex justify-between mt-4'>
                    <button className='bg-white text-gray-800 py-2 px-4 rounded-lg shadow-lg transform transition-all duration-300 hover:bg-white-700 hover:scale-105 hover:shadow-2xl'>Failed</button>
                </div>
            </div>
        </>
    )
